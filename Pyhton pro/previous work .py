...
if choice==1: #Use of conditional statement to check input 
    user_name=input('enter your user name=')
    password=input('enter your password=')
    while user_name=='shivam' and password=='shivam123':
